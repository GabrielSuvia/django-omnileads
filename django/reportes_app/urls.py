...
from reportes_app import views_reportes_premium
...
urlpatterns = [
    ...
    # Reportes Premium
    # ==========================================================================
    path('reporte/premium/reporte1/',
            login_required(views_reportes_premium.ReportesPremium.as_view()),
            name='reporte_premium1',
            ),
]
